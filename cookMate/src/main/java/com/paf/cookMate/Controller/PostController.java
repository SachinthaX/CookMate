...
import com.paf.cookMate.Dto.PostRequest;
import com.paf.cookMate.Dto.PostResponse;
import com.paf.cookMate.Model.Comment;
import com.paf.cookMate.Service.PostService;
...
public class PostController {
    ...
    //  Create a new post
    @PostMapping
    public PostResponse createPost(@CurrentUser String userId, @RequestBody PostRequest postRequest) {
